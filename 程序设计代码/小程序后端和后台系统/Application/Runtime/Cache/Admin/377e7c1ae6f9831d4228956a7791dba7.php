					...
					<table class="site-table table-hover">
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>	
								...
								<td style="width: 120px;padding: 2px">
									...
									<a type="button" class="layui-btn layui-btn-small" href="/index.php/Admin/User/edit/id/<?php echo ($vol["id"]); ?>">
										<i class="layui-icon">
											
										</i>
									</a>
									<a type="button" class="layui-btn layui-btn-small" href="/index.php/Admin/User/del/id/<?php echo ($vol["id"]); ?>" > 
										<i class="layui-icon">
											
										</i>
									</a>
