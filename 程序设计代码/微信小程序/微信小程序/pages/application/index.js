...
Page({
  ...
  onLoad: function(options) {
    ...
    wx.request({
      url: 'https://118.25.4.219/tsg/index.php/Home/Wechat/seat/floor/' + '1',
      header: {
      ...
      success: function(res) {
        ...
        wx.request({
          ...
          success: function(e) {
            ...
            wx.request({
              url: 'https://118.25.4.219/tsg/index.php/Home/Wechat/seachuser/openid/' + e.data,
              header: {
                'content-type': 'application/json'
              },
              method: 'GET',
  ...
  floor: function(e) {
    ...
    //获取选中楼层的座位信息
    wx.request({
      url: 'https://118.25.4.219/tsg/index.php/Home/Wechat/seat/floor/' + id,
      header: {
        'content-type': 'application/json'
      },
      method: 'GET',
  ...
  btn_ok: function(e) {
    ...
    if (seatid == '') {
      ...
      wx.request({
        url: 'https://118.25.4.219/tsg/index.php/Home/Wechat/appointment',
        header: {
          'content-type': 'application/json'
        },
        data: {
